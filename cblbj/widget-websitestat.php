...
// 		$this->WP_Widget(false, '觅知 网站统计', $widget_ops);
		parent::__construct( false, '觅知 网站统计', $widget_ops);
	}
	...
	function efan_get_websitestat($establish_time){
		...
		$output .= $link;
		$output .= ' 个</li></div></div></div>';
		$output .= '<div class="widgest-bg widgest-bg6"><div class="widgest-main"><div class="widgest-meat"><li>觅知朋友：';
		$output .= $users;
